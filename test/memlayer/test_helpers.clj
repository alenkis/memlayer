...
(defn make-test-handlers
  ...
  {:retain       (retain/handler flow)
   ...
   :dashboard    {:me               (dashboard/me-handler deps)
                  :list-tokens      (dashboard/list-tokens-handler deps)
                  :create-token     (dashboard/create-token-handler deps)
                  :revoke-token     (dashboard/revoke-token-handler deps)
                  :active-token     (dashboard/active-token-handler deps)
                  :settings         (dashboard/settings-handler deps)
                  :save-keys        (dashboard/save-keys-handler deps)
                  :delete-keys      (dashboard/delete-keys-handler deps)
                  :usage            (dashboard/usage-handler deps)
